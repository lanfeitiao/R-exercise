...
states <- read_sf("map/data/census_bureau/cb_2013_us_state_20m/cb_2013_us_state_20m.shp")
counties <- read_sf("map/data/census_bureau/cb_2013_us_county_20m/cb_2013_us_county_20m.shp")

# Load the census data about the foreign born population, and calculate the rate of foreign born population
fb_state <- read.csv("map/data/census_bureau/ACS_13_5YR_B05012_state/ACS_13_5YR_B05012.csv", 
                     stringsAsFactors=FALSE, colClasses=c("GEO.id2"="character"))
fb_state$rate <- fb_state$HD01_VD03 / fb_state$HD01_VD01
fb_county <- read.csv("map/data/census_bureau/ACS_13_5YR_B05012_county/ACS_13_5YR_B05012.csv",
                      stringsAsFactors=FALSE, colClasses=c("GEO.id2"="character"))
...
world <- st_read("map/data/natural_earth/ne_110m_admin_0_countries/ne_110m_admin_0_countries.shp")

# Load the fertility data
fertility <- read.csv("map/data/API_SP.DYN.TFRT.IN_DS2_en_csv_v2/API_SP.DYN.TFRT.IN_DS2_en_csv_v2.csv", stringsAsFactors=FALSE)
